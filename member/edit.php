      ...
      <div class="admincontrolprofileedit">
        ...
        <div class="admincontrolprofileeditright">
          <form action="update.php" method="post" class="theform">
            <ul>
              <li class="">
                <label class="description">Nama Pemilik</label> <span><input value=
                "<?php echo $row['ownerFn']; ?>" size="20" maxlength="255" class="element text"
                name="OwnerFn" /> <label>First</label></span> <span><input value=
                "<?php echo $row['ownerLn']; ?>" size="30" maxlength="255" class="element text"
                name="OwnerLn" /> <label>Last</label></span>
              ...
              <li class="">
                ...
                <div>
                  <textarea class="element textarea medium" name="pengumuman">
$Pengumuman untuk pembeli ( halaman profile )
</textarea>
                </div>
              ...
              <li class="">
                ...
                <div>
                  <textarea class="element textarea medium" name="introduction">
<?php echo $row['introduction']; ?>
              ...
              <li class="">
                ...
                <div>
                  <textarea class="element textarea medium" name="companyAddress">
<?php echo $row['companyAddress']; ?>
              ...
              <li class="">
                ...
                <div>
                  <input type="text" value="<?php echo $row['companyEmail']; ?>" maxlength="255"
                  class="element text medium" name="companyEmail" />
                </div>
              ...
              <li class="">
                ...
                <div>
                  <input type="text" value="<?php echo $row['companyPhone']; ?>" maxlength="255"
                  class="element text medium" name="companyPhone" />
                </div>

                <p class="guidelines"><small>deskripsi tentang telphon</small></p>
              </li>

              <li class="buttons"><input type="hidden" value="" name="" /><input type="submit"
              value="Edit Profile" name="submit" class="button_text" /></li>
            </ul>
          </form>
        </div>
