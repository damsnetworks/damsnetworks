...
<div class="container">
	...
	<form action="" method="post" class="pertanyaan" id="pendaftaran">
		...
		</div><p id="guide_2" class="guidelines"><small>Masukan kata kunci anda, usahakan lakukan pengabungan antara text dan angka untuk keamanan lebih.</small></p> 
		</li>		<li id="li_5" class="">
		...
		<span>
			<input value="" size="14" maxlength="255" class="element text" name="element_5_2" id="element_5_2">
			<label>Last</label>
		...
		</div><p id="guide_3" class="guidelines"><small>Masukan kata perkenalan bisnis anda, akan kami gunakan pada halaman bisnis anda.</small></p> 
		</li>		<li id="li_4" class="">
		...
		<label for="element_6_3" class="choice">Gold Partneship</label>
				...
				<li class="buttons">
				<input type="hidden" value="174263" name="form_id">
